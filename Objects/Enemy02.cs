...
namespace Galaga
{
    ...
    class Enemy02 :GameObject
    {
        public Enemy02()
        {
            ...
            spriteComponent.Image = Resources.Enemy_02_01;
            AddComponent(spriteComponent);

            AnimationSprite animationSprite = new AnimationSprite(this);
            animationSprite.ImageList.Add(Resources.Enemy_02_01);
            animationSprite.ImageList.Add(Resources.Enemy_02_02);
